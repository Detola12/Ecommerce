                        ...
                        <div class="col-lg-6 col-md-6 col-12 col-sm-6">
                            <div class="slider-content-1 slider-animated-1 ml-70">
                                ...
                                <div class="slider-btn-1 default-btn btn-hover">
                                    <a class="animated btn-color-theme btn-size-md btn-style-outline" href="{{ route('show_product') }}">SHOP NOW</a>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <div class="product-area pt-130 pb-135">
        <div class="container">
            <div class="section-title text-center mb-40">
                <h2>@if (count($likedProducts) >= 4) Liked Products @else For You @endif</h2>
                <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text</p>
            </div>
            <div class="product-slider-active owl-carousel">
                @if (count($likedProducts) >= 4)
            ...
            <div class="row">
                ...
                <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                    <div class="product-wrap mb-35">
                        <div class="product-img mb-15">
                            <a href="product-details.html"><img src="@if($item->image != '')
                        ...
                        <div class="product-content">
                            ...
                            <div class="price-addtocart">
                                ...
                                <div class="product-addtocart">
                                    <a title="Add To Cart" id="{{ $item->id }}" class="product_item" href="{{ route('add_to_cart', $item->id) }}">+ Add To Cart</a>
                                </div>
                            </div>
                        </div>
                    </div>
